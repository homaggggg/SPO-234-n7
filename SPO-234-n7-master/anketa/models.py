...
#    professia = models.ForeignKey(Professia, on_delete=models.PROTECT, verbase_name='Профессия')#
...
class Question(models.Model):
    ...
    skill = models.ForeignKey(Skill, on_delete=models.PROTECT, verbase_name='Навык')
...
class ModelProf(models.Model):
    title = models.ForeignKey(Professia, on_delete=models.PROTECT, verbase_name='Название')
    skill = models.ForeignKey(Skill, on_delete=models.PROTECT, verbase_name='Навык')
...
class Sert(models.Model):
    ...
    user = models.TextField(max_length=50, verbose_name = "Пользователь")
    key_skill = models.ForeignKey(Skill, on_delete=models.PROTECT, verbase_name='Ключевой навык')
    all_skills = models.ForeignKey(Skill, on_delete=models.PROTECT, verbase_name='Все навыки')
